...
rem Set counter to track number of unique searches
set count=0

:loop
rem Stop when 45 unique searches are completed
if %count% GEQ 45 (
    echo Completed 45 unique searches. Exiting...
    exit /b
)
